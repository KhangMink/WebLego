...
<div class="col-md-6">
  ...
  <div class="form-group">
    ...
    <input type="text" name="title_category_product" class="form-control" id="email">
  </div>
  <div class="form-group">
    <label for="pwd">Mô tả danh mục</label>
    <textarea style="resize: none;"rows="5" class="form-control" name="desc_category_product"></textarea>
