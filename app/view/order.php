                              ...
                              <tr class="tr">
                                 ...
                                 <td data-th="Giá"><span class="color_red font_money"><?php echo number_format($value['price_product'],0,',','.').'vnđ' ?></span></td>
                                   <?php if($value['order_status']==0){
                                    ...
                                    <div class="clear margintop5">
                                       <div class="floatleft">
                                          <input type="number" min="1" max="20" class="inputsoluong" value="<?php echo $value['product_quantity'] ?>" name="quantity"></div>
                                ...
                                <?php }
                                 ...
                                 <?php if($value['order_status']==0){
                                    ...
                                    href="<?php echo BASE_URL?>donhang/xoadonhang/<?php echo  $value['order_details_id']?>"class="btn btn-sm btn-warning" id="">Hủy</a>                          
                                 </td>
                                 <?php } 
                                 ?>
