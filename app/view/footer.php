                  ...
                  <div class="footer-col">
                     ...
                     <div class="footer-col-content">
                        <ul class="social">
                           ...
                           <li><a href="#2" class="fb"><img src="<?php echo BASE_URL ?>public/image/Fb.png">Google</a></li>
                        </ul>
                        <div class="clear"></div>
                     </div>
                  </div>
                        ...
                        <ul class="icon_list">
                           <li>
                              <a href=".">
                                 ...
                                 <p class="text_li">
                                    <span class="phone_footer">Hotline:0338-402-416 </span>
                                    <span class="text_small">(Từ 8h đến 20h tất cả các ngày)</span>
                                 </p>
                              </a>
                           </li>
                           <div class="clear"></div>
                           <li><a><i class="fa fa-envelope" aria-hidden="true"></i>  legoworld@gmail.com</a></li>
            ...
            <div class="bg_in">
               <div class="footer">
                  <div class="infor_company">
                     ...
                     <p class="note_mst">GPĐKKD số: 7777777. Cấp lần 1: 10/10/2015. Thay đổi: 10/10/2010. Nơi cấp: Phòng đăng ký kinh doanh Sở kế hoạch đầu tư TP Thái Nguyên</p>
                  </div>
                  <div class="footer-col">
                     <h4>TRỤ SỞ CHÍNH</h4>
                     <div class="infor_footer">
                        <address>
                        <address>Địa Chỉ : 439/4/20 KP1,Phường Tân Thành,Thành Phố Thái Nguyên,Tỉnh Thái Nguyên <br />
                           Điện thoại: 0338-402-416<br />
                           Email: legoworld@gmail.com
                        </address>
                        </address>
                     </div>
                  </div>
                  <div class="footer-col">
                     ...
                     <div class="infor_footer">
                        <address>
                        <address>Địa Chỉ : 60,Phường Tân Thịnh,Thành Phố Thái Nguyên,Tỉnh Thái Nguyên  <br />
                           Điện thoại: 0338-402-416<br />
                           Email: legoworld@gmail.com
                        </address>
                        </address>
    ...
    <!--   <div class="coccoc-alo-phone coccoc-alo-green coccoc-alo-show" id="coccoc-alo-phoneIcon" >
      ...
      <script defer type="text/javascript" src="<?php echo BASE_URL ?>public/js/script_menu.js"></script>
            <script src="<?php echo BASE_URL ?>public/js/cloudzoom.js"></script>
      <script defer src="<?php echo BASE_URL ?>public/js/jquery.scrollto.js"></script>
